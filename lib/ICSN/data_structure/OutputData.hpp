...
struct OutputData {
  ...
  OutputData(const std::string& senderId, const std::set<std::string>& destId,
...
inline OutputData makeOutput(const std::string& dest, const std::set<std::string>& destId,
                             const std::string& signal, int hopCount,
                             const std::string& contentName, const std::string& contentValue) {
